  ...
  capitulos: [
    {
      ...
      versos: [
        ...
        {
          numero: 2,
          texto: "Desde o princípio, a Palavra estava com Deus.",
        },
        {
          numero: 3,
          texto:
        ...
        {
          numero: 6,
          texto: "Houve um homem chamado João, que foi enviado por Deus",
        },
        {
          numero: 7,
          texto:
        ...
        {
          numero: 8,
          texto: "João não era a luz, mas veio para falar a respeito da luz,",
        },
        {
          numero: 9,
          texto:
        ...
        {
          numero: 20,
          texto: " João afirmou claramente: — Eu não sou o Messias.",
        },
        {
          numero: 21,
          texto:
        ...
        {
          numero: 24,
          texto: "Os que foram enviados eram do grupo dos fariseus;",
        },
        {
          numero: 25,
          texto:
        ...
        {
          numero: 44,
          texto: "Filipe era de Betsaida, de onde eram também André e Pedro.",
        },
        {
          numero: 45,
          texto:
    ...
    },
    {
      ...
      versos: [
        ...
        {
          numero: 5,
          texto: "Então ela disse aos empregados: — Façam o que ele mandar.",
        },
        {
          numero: 6,
          texto:
        ...
        {
          numero: 24,
          texto: "Mas Jesus não confiava neles, pois os conhecia muito bem.",
        },
        {
          numero: 25,
          texto:
    ...
    },
    {
      ...
      versos: [
        ...
        {
          numero: 9,
          texto: "— Como pode ser isso? — perguntou Nicodemos.",
        },
        {
          numero: 10,
          texto:
        ...
        {
          numero: 15,
          texto: "para que todos os que crerem nele tenham a vida eterna.",
        },
        {
          numero: 16,
          texto:
        ...
        {
          numero: 24,
          texto: "(João ainda não tinha sido preso.)",
        },
        {
          numero: 25,
          texto:
        ...
        {
          numero: 35,
          texto: "O Pai ama o Filho e pôs tudo nas mãos dele.",
        },
        {
          numero: 36,
          texto:
      ...
      eventos: [
        "O Novo Nascimento",
        "O Amor de Deus (de nos dar Seu único filho)",
    ...
    },
    {
      ...
      versos: [
        ...
        {
          numero: 4,
          texto: "No caminho, ele tinha de passar pela região da Samaria.",
        },
        {
          numero: 5,
          texto:
        ...
        {
          numero: 16,
          texto: "— Vá chamar o seu marido e volte aqui! — ordenou Jesus.",
        },
        {
          numero: 17,
          texto:
        ...
        {
          numero: 41,
          texto: "E muitos outros creram por causa da mensagem dele.",
        },
        {
          numero: 42,
          texto:
    ...
    },
    {
      ...
      versos: [
        ...
        {
          numero: 8,
          texto: "Então Jesus disse: — Levante-se, pegue a sua cama e ande!",
        },
        {
          numero: 9,
          texto:
        ...
        {
          numero: 40,
          texto: "Mas vocês não querem vir para mim a fim de ter vida.",
        },
        {
          numero: 41,
          texto: "— Eu não procuro ser elogiado pelas pessoas.",
        },
        {
          numero: 42,
          texto:
    ...
    },
    {
      ...
      versos: [
        ...
        {
          numero: 3,
          texto: "Ele subiu um monte e sentou-se ali com os seus discípulos.",
        },
        {
          numero: 4,
          texto: "A Páscoa, a festa principal dos judeus, estava perto.",
        },
        {
          numero: 5,
          texto:
        ...
        {
          numero: 8,
          texto: "Então um dos discípulos, André, irmão de Simão Pedro, disse:",
        },
        {
          numero: 9,
          texto:
        ...
        {
          numero: 16,
          texto: "De tardinha, os discípulos de Jesus desceram até o lago.",
        },
        {
          numero: 17,
          texto:
        ...
        {
          numero: 20,
          texto: "Mas Jesus disse: — Não tenham medo, sou eu!",
        },
        {
          numero: 21,
          texto:
        ...
        {
          numero: 43,
          texto: "Jesus respondeu: — Parem de resmungar contra mim.",
        },
        {
          numero: 44,
          texto:
    ...
    },
    {
      ...
      versos: [
        ...
        {
          numero: 24,
          texto: "Parem de julgar pelas aparências e julguem com justiça.",
        },
        {
          numero: 25,
          texto:
        ...
        {
          numero: 29,
          texto: "Mas eu o conheço porque venho dele e fui mandado por ele.",
        },
        {
          numero: 30,
          texto:
        ...
        {
          numero: 46,
          texto: "Eles responderam: — Nunca ninguém falou como ele!",
        },
        {
          numero: 47,
          texto:
        ...
        {
          numero: 48,
          texto: "Por acaso alguma autoridade ou algum fariseu creu nele?",
        },
        {
          numero: 49,
          texto: "Essa gente que não conhece a Lei está amaldiçoada por Deus.",
        },
        {
          numero: 50,
          texto:
    ...
    },
    {
      ...
      versos: [
        ...
        {
          numero: 8,
          texto: "Depois abaixou-se outra vez e continuou a escrever no chão.",
        },
        {
          numero: 9,
          texto:
        ...
        {
          numero: 36,
          texto: "Se o Filho os libertar, vocês serão, de fato, livres.",
        },
        {
          numero: 37,
          texto:
        ...
        {
          numero: 45,
          texto: "Mas, porque eu digo a verdade, vocês não creem em mim.",
        },
        {
          numero: 46,
          texto:
        ...
        },
        {
          numero: 54,
          texto:
            "Ele respondeu: — Se eu elogiasse a mim mesmo, os meus elogios não valeriam nada. Quem me elogia é o meu Pai, o mesmo que vocês dizem que é o Deus de vocês.",
        },
        {
          numero: 55,
          texto:
      ...
      eventos: [
        "Jesus Perdoa Mulher Apanhada em Adultério",
    ...
    },
    {
      ...
      versos: [
        ...
        {
          numero: 5,
          texto: "Enquanto estou no mundo, eu sou a luz do mundo.",
        },
        {
          numero: 6,
          texto:
        ...
        {
          numero: 10,
          texto: "— Como é que agora você pode ver? — perguntaram.",
        },
        {
          numero: 11,
          texto:
        ...
        {
          numero: 13,
          texto: "Então levaram aos fariseus o homem que havia sido cego.",
        },
        {
          numero: 14,
          texto:
    ...
    },
    {
      ...
      versos: [
        {
          numero: 1,
          texto: "Jesus disse: — Eu afirmo a vocês que isto é verdade: quem não entra no curral das ovelhas pela porta, mas pula o muro é um ladrão e bandido."
        },
        {
          numero: 2,
          texto: "Mas quem entra pela porta é o pastor do rebanho."
        },
        {
          numero: 3,
          texto: "O porteiro abre a porta para ele. As ovelhas reconhecem a sua voz quando ele as chama pelo nome, e ele as leva para fora do curral."
        },
        {
          numero: 4,
          texto: "Quando todas estão do lado de fora, ele vai na frente delas, e elas o seguem porque conhecem a voz dele."
        },
        {
          numero: 5,
          texto: "Mas de jeito nenhum seguirão um estranho! Pelo contrário, elas fugirão, pois não conhecem a voz de estranhos."
        },
        {
          numero: 6,
          texto: "Jesus fez esta comparação, mas ninguém entendeu o que ele queria dizer."
        },
        {
          numero: 7,
          texto: "Então Jesus continuou: — Eu afirmo a vocês que isto é verdade: eu sou a porta por onde as ovelhas passam."
        },
        {
          numero: 8,
          texto: "Todos os que vieram antes de mim são ladrões e bandidos, mas as ovelhas não deram atenção à voz deles."
        },
        {
          numero: 9,
          texto: "Eu sou a porta. Quem entrar por mim será salvo; poderá entrar e sair e achará comida."
        },
        {
          numero: 10,
          texto: "O ladrão só vem para roubar, matar e destruir; mas eu vim para que as ovelhas tenham vida, a vida completa."
        },
        {
          numero: 11,
          texto: "— Eu sou o bom pastor; o bom pastor dá a vida pelas ovelhas."
        },
        {
          numero: 12,
          texto: "Um empregado trabalha somente por dinheiro; ele não é pastor, e as ovelhas não são dele. Por isso, quando vê um lobo chegando, ele abandona as ovelhas e foge. Então o lobo ataca e espalha as ovelhas."
        },
        {
          numero: 13,
          texto: "O empregado foge porque trabalha somente por dinheiro e não se importa com as ovelhas."
        },
        {
          numero: 14,
          texto: "Eu sou o bom pastor; conheço as minhas ovelhas, e elas me conhecem,"
        },
        {
          numero: 15,
          texto: "assim como o Pai me conhece, e eu conheço o Pai. E estou pronto para morrer por elas."
        },
        {
          numero: 16,
          texto: "Tenho outras ovelhas que não estão neste curral. Eu preciso trazer essas também, e elas ouvirão a minha voz. Então elas se tornarão um só rebanho com um só pastor."
        },
        {
          numero: 17,
          texto: "— O Pai me ama porque eu dou a minha vida para recebê-la outra vez."
        },
        {
          numero: 18,
          texto: "Ninguém tira a minha vida de mim, mas eu a dou por minha própria vontade. Tenho o direito de dá-la e de tornar a recebê-la, pois foi isso o que o meu Pai me mandou fazer."
        },
        {
          numero: 19,
          texto: "Quando ouviu isso, o povo se dividiu outra vez. Muitos diziam:"
        },
        {
          numero: 20,
          texto: "— Ele está dominado por um demônio! Está louco! Por que é que vocês escutam o que ele diz?"
        },
        {
          numero: 21,
          texto: "Outros afirmavam: — Quem está dominado por um demônio não fala assim! Será que um demônio pode dar vista aos cegos?"
        },
        {
          numero: 22,
          texto: "Era inverno, e em Jerusalém estavam comemorando a Festa da Dedicação."
        },
        {
          numero: 23,
          texto: 'Jesus estava andando pelo pátio do Templo, perto da entrada chamada "Alpendre de Salomão".'
        },
        {
          numero: 24,
          texto: "Então o povo se ajuntou em volta dele e perguntou: — Até quando você vai nos deixar na dúvida? Diga com franqueza: você é ou não é o Messias?"
        },
        {
          numero: 25,
          texto: "Jesus respondeu: — Eu já disse, mas vocês não acreditaram. As obras que eu faço pelo poder do nome do meu Pai falam a favor de mim,"
        },
        {
          numero: 26,
          texto: "mas vocês não creem porque não são minhas ovelhas."
        },
        {
          numero: 27,
          texto: "As minhas ovelhas escutam a minha voz; eu as conheço, e elas me seguem."
        },
        {
          numero: 28,
          texto: "Eu lhes dou a vida eterna, e por isso elas nunca morrerão. Ninguém poderá arrancá-las da minha mão."
        },
        {
          numero: 29,
          texto: "O poder que o Pai me deu é maior do que tudo, e ninguém pode arrancá-las da mão dele."
        },
        {
          numero: 30,
        ...
        {
          numero: 31,
          texto: "Então eles tornaram a pegar pedras para matar Jesus."
        },
        {
          numero: 32,
          texto:
        ...
        {
          numero: 37,
          texto: "Se não faço o que o meu Pai manda, não creiam em mim."
        },
        {
          numero: 38,
          texto:
        ...
        {
          numero: 42,
          texto: "E naquele lugar muita gente creu em Jesus."
        }
      ],
      eventos: [
